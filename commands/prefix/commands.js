...
module.exports = {
    name: 'commands',
    description: 'Shows all the registered slash and prefix commands',
    async execute(message, args) {
      const commandEmbed = await listCommands();
        await message.channel.send({ embeds: [commandEmbed] }); // Reply with the command list
    }
}